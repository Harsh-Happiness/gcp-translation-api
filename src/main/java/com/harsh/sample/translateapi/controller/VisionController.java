...
//
//
//    @RequestMapping(value = "/convertFileToText", method = {RequestMethod.POST})
//    public String getVisionFileToText(){
//        try {
//            detectDocumentsGcs("gs://cloud-samples-data/vision/pdf_tiff/census2010.pdf","gs://gcpdocstorage/");
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
...
//                Page<Blob> pageList = bucket.list(Storage.BlobListOption.prefix(prefix));
//
